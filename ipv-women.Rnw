...
results <- kriging.full.pipeline.f(asia.exposure.input.data, regularisation.factor = 5)
...
results <- kriging.full.pipeline.f(asia.attitudes.input.data, regularisation.factor = 5)
serializable.raster <- terra::wrap(results[[1]])
serializable.border <- terra::wrap(results[[2]])
