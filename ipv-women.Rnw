...
terra::plot(my.raster, col = my.palette.f(101), range = c(0, 1), plg = list(at = seq(from = 0, to = 1, by = 0.1)), axes = TRUE, xlim = terra::ext(africa)[c(1, 2)], ylim = terra::ext(africa)[c(3, 4)])
