...
pop_data <- wbstats::wb_data("SP.POP.TOTL", country = iso.3166$String.code[match(unique(justifyIPV_cluster$country.code.ISO.3166.alpha.3), iso.3166$numeric)], start_date = 2019, end_date = 2019)
