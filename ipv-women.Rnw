...
library(xtable)
print(xtable(check.alignment.tab, label = "tab:alignment", caption = "Verify that the model matrix and the parameters matrix are aligned, ie that the row ordering is the same in both."), booktabs = TRUE)
@
\end{footnotesize}
