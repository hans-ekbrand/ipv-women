...
<<splines-plot-marginal-effect, fig.cap = paste0("Lower bounds of the high density interval of the marginal effect of the attitudes of the other women in the local area on the probability of IPV. For couples where no one justifies IPV, the effect of the attitudes neighbourhood becomes statistically significant when the proportion of women in the neighbourhood is above", round(marginal.effect.positive.at[0], 2), "."), fig.height=4, fig.width = 6, fig.align = "center", dev="png">>=
par(mar = c(4, 5, 5, 14))
