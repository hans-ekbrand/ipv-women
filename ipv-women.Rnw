...
<<splines-plot-marginal-effect, fig.cap = paste0("Lower bounds of the credible intervals of the marginal effect of the attitudes of the other women in the local area on the probability of IPV. For couples where no one justifies IPV, the effect of the attitudes of the neighbourhood becomes 'statistically significant' when the proportion of women in the neighbourhood who thinks IPV can be justified is above ", round(marginal.effect.positive.at[1], 2), ". The other types of couples are less susceptible to the attitudes of the women in the neighbourhood, but even in couples where both the husband and the wife thinks IPV can be justified, the attitudes of the neighbourhood have a measurable effect when the proportion of women in the neighbourhood who thinks IPV can be justified is above ", round(marginal.effect.positive.at[2], 2), "."), fig.height=4, fig.width = 6, fig.align = "center", dev="png">>=
par(mar = c(4, 5, 5, 14))
