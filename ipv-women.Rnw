...
my.sum <- sum(pop_data.1$SP.POP.TOTL[which(pop_data$country %in% c(countries.africa, c("Afghanistan", "Cambodia", "India", "Pakistan", "Myanmar", "Nepal", "Philippines", "Bangladesh")))])
...
my.sum <- sum(pop_data.2$SP.POP.TOTL[which(pop_data$country %in% c(countries.africa, c("Afghanistan", "Cambodia", "India", "Pakistan", "Myanmar", "Nepal", "Philippines", "Bangladesh")))])
