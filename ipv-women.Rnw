...
<<splines-plot-predictions, fig.cap = "Predicted probabilities for a woman to be exposed to IPV conditioned on the attitudes in the couple and the attitudes of the other women in the local area.", fig.height=4, fig.width = 6, fig.align = "center", dev="png">>=
par(mar = c(4, 5, 5, 14))
