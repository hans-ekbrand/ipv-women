...
my.dt.clean <- my.dt.temp[which(is.na(beat01_couple) == FALSE &
                                ...
                                is.na(iwi2) == FALSE),                                
                          list(viol01_wife, beat01_couple, v149, edudeviation, decide2_purchases, decide2_health, gdi_s, gni_s, viol01_cluster, justifyIPV_cluster, iwi2, country, cluster1, ln_numb_of_children, lnage_wife, couple.is.illiterate, lon, lat), ]
